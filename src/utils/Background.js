 ...
 */
const scheduleBackgroundProcessingTask = async (taskName, timeout, taskExecutionCallback, taskExpiredCallback) => {
    ...
    try {
        ...
        PLXEventEmitter.removeListener(BackgroundProcessingExecuting, executingCallback);
...
const completeBackgroundProcessingTask = (taskName, result) => {
    ...
    if (callbacks != null) {
        PLXEventEmitter.removeListener(BackgroundProcessingExecuting, callbacks.execution);
        PLXEventEmitter.removeListener(BackgroundProcessingExpired, callbacks.expired);
